...
path = r'/Users/rubenoussoren/Google Drive/Finance/Romancing Financing.xlsx'

# Assigning CSV File into Python and Assigning Column Names
df = pandas.read_csv(r'/Users/rubenoussoren/Google Drive/Projects/Github/Sensitive Info/Bank Statements/' + file_name + '.csv', header = None) 
